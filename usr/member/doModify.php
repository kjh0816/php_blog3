...
$loginPwConfirm = getStrValueOr($_POST['loginPwConfirm'], "");
...
$name = getStrValueOr($_POST['name'], "");
if(empty($name)){
    jsHistoryBackExit("이름을 입력해주세요.");
}

$nickname = getStrValueOr($_POST['nickname'], "");
if(empty($nickname)){
    jsHistoryBackExit("닉네임을 입력해주세요.");
}

$cellphoneNo = getStrValueOr($_POST['cellphoneNo'], "");
if(empty($cellphoneNo)){
    jsHistoryBackExit("핸드폰 번호를 입력해주세요.");
}

$email = getStrValueOr($_POST['email'], "");
if(empty($email)){
